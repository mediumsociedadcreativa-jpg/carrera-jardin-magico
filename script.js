...
imgBotonJugar.src = "imagenes/boton_jugar.png"; 
...
function cargarImagenesJuego(alTerminar) {
    ...
    imgFondo.onerror = () => console.error("Falta: imagenes/fondo.png");
    ...
    prefijosArchivos.forEach(prefijo => {
        ...
        acciones.forEach(accion => {
            ...
            img.onerror = () => console.error(`Falta: imagenes/${prefijo}_${accion}.png`);
